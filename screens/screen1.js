...
return <View style={{ width: '100%', gap: 15, padding: 15 }}>
    ...
    <View style={{ marginTop: 10}}>
        <Pressable onPress={() => { navigation.navigate('screen2') }} style={{ paddingVertical: 15, width: '100%', borderWidth: 1, borderColor: 'gray', borderRadius: 10, flexDirection:"row", justifyContent:"space-between"}}>
            <Text style={{ textTransform: 'uppercase', fontSize: 18, textAlign: 'center', paddingLeft:"30%"}}>
                4 Màu-chọn màu
            </Text>
            <Image source={require('/assets/Vector.png')} style={{ width: 11, height: 14, marginRight: 20}} />
        </Pressable>
    </View>
